...
Use gsub function for pattern replacement to clean up the data activity names.
...
group_by activities and subject, we need to produce only a tidy data set with the average of each veriable.